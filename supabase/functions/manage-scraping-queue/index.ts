...
serve(async (req) => {
    ...
    try {
        ...
        if (action === 'update_status') {
            ...
            console.log('update_source_info action called:', { id, source_name, notes });
            ...
            console.log('Updating source_registry with:', updates);
            ...
            console.log('Update result:', { error: result.error, data: result.data });
        } else {
